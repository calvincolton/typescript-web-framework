...
function () {
  ...
  View.prototype.bindEvents = function (fragment) {
    ...
    var _loop_1 = function _loop_1(eventKey) {
      ...
      fragment.querySelectorAll(selector).forEach(function (elem) {
...
function (_super) {
  ...
  UserList.prototype.renderItem = function (model, itemParent) {
    var userShow = new UserShow_1.UserShow(itemParent, model);
    userShow.render();
  };
...
function () {
  function Eventing() {
    ...
    this.on = function (eventName, callback) {
      var handlers = _this.events[eventName] || []; // Callback[] or undefined
...
function () {
  ...
  Attributes.prototype.set = function (props) {
